...
import bottom from "../assets/images/botoms.jpg";
...
export default { profile, thumbnail, cards, path, logo, logoSmall, empty, header, bottom, jacket, sandals, top, barbie, academia, brat, goth, street, corporate, cottage , header2};
